...
| **EventHubConnectionString** | Required | `string`| The connection string for the Event Hub namespace.<br><br>Allowed value:  The primary or secondary connection string as copied from the Azure portal.<br>Default value: `null`|
...
| **BlobContainerName** | Required | `string` | The name of the container in the Blob Storage account used to store event hub checkpoints. <br><br>Allowed value:  3-63 characters long; contains only letters, numbers, and dash characters per Azure restrictions.|
