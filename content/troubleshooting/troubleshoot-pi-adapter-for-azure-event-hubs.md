...
1. Navigate to [data source configuration](xref:PIAdapterForAzureEventHubsDataSourceConfiguration) and verify that <!-- Insert data source parameters that need to be checked --> are correct.
...
1. Navigate to the logs directory:<br>
    Windows: `%ProgramData%\OSIsoft\Adapters\EventHubs\Logs`<br>
